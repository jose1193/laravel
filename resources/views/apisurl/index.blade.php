...
<!-- INDEX SHOW APIS CRUD--> 
    <div class="max-w-5xl mx-auto mt-8 my-5 pb-5 py-5">

 
   

      <div class="flex justify-end mt-10">
          <a href="{{ route('apisurl.create') }}" class="bg-primary-700 hover:bg-primary-800 focus:ring-4
          focus:ring-primary-300 font-medium rounded-lg
           text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2
            dark:bg-primary-600 dark:hover:bg-primary-700 
            focus:outline-none dark:focus:ring-primary-800 text-white">+ Create New Api</a>
      </div>
                            ...
                            <tr class="bg-white border-b">
                              ...
                              <td class="text-sm text-gray-900 font-bold px-6 py-4 whitespace-nowrap">
                                <form action="{{ route('apisurl.destroy',$apisurl->id) }}" id="form-delete" method="POST">
                                  ...
                                  <a href="{{ route('apisurl.edit',$apisurl->id) }}" class="text-indigo-600 hover:text-indigo-900 ">
                                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
