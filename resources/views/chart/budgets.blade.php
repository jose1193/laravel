    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 mx-auto">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="/chart" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">
            <a href="/chart" class="text-blue-600 hover:text-blue-700">@yield('titulo')</a></a>
        </div>
      </li>
...
<!-- INDEX SHOW CHART--> 
    <div class="max-w-4xl mx-auto mt-8 my-5 pb-5 py-5">
        ...
        <p class=" capitalize font-bold text-center text-blue-700 mt-5"><span class="text-purple-700">
          total expenses current year: {{date('Y')}} </span><br> ${{ number_format($sum, 2, ',', ' ') }} 
       </p>
  </div>
