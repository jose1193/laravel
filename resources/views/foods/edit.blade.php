    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 mx-auto">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="{{ route('foods.edit', [$food->id, 'id' => $id]) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">
            <a href="{{ route('foods.edit', [$food->id, 'id' => $id]) }}" class="text-blue-600 hover:text-blue-700">@yield('titulo')</a></a>
        </div>
      </li>
                        ...
                        <form action="{{ route('foods.update',$food->id) }}"
                            ...
                            <div >
                                ...
                                focus:outline-none focus:ring-1 focus:ring-blue-600" 
                                 name="description"  value="{{ $food->description }}"  required maxlength="50" >
                            </div>
                            ...
                            <div >
                                ...
                                class="w-full px-4 py-2 mt-2 mb-5 border rounded-md 
                                focus:outline-none focus:ring-1 focus:ring-blue-600" 
                                 name="unitquantity" value="{{ $food->unitquantity }}"
                            ...
                            <div>
                                ...
                                class="  w-full px-4 py-2 mt-2 mb-5 border rounded-md 
                                focus:outline-none focus:ring-1 focus:ring-blue-600" 
                                name="total" jAutoCalc="{unitquantity} * {price} * {dollar}"
                                 value="{{ $food->total }}"
                            ...
                            <div>
                                ...
                                class="  w-full px-4 py-2 mt-2 border rounded-md 
                                focus:outline-none focus:ring-1 mb-5 focus:ring-blue-600" 
                                name="idbudgetfood" required maxlength="100"
                                 readonly value="{{$id}}">
                            </div>
