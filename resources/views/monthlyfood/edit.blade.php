            ...
            <div class="flex flex-col">
                <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    ...
                    <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10"> 
                        ...
                        <form action="{{ route('monthlyfood.update',$monthlyfood->id) }}" id="calculator"
                            method="POST" autocomplete="off">
                            @csrf
                            @method('PUT')

                            <div >
                                <label class="block text-md font-bold text-gray-700" for="title">Amount</label>
                                <input type="text" placeholder="Amount"
                                class="w-full px-4 py-2 mt-2 mb-5 border rounded-md 
                                focus:outline-none focus:ring-1 focus:ring-blue-600" 
                                  value="{{ $monthlyfood->amount }}"
