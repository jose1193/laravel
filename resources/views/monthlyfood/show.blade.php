    ...
    <div class="max-w-4xl mx-auto mt-8 my-5 pb-5 py-5">
        ...
        <div class="flex flex-col mt-5 py-5">
            <div class="w-full px-6 py-4 bg-white rounded shadow-lg ring-1 ring-gray-900/10">
                <h3 class="text-2xl font-semibold">Budget: {{ $monthlyfood->amount }} $</h3>
               
                <p class="text-2xl text-blue-700 mt-5"><span class="text-purple-700">Date: </span>{{ $monthlyfood->date }}</p>
            </div>
        </div>
    </div>
