            ...
            <div class="flex justify-end mt-5">
                ...
                focus:ring-primary-300 font-medium rounded-lg
                 text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2
                  ...
                  focus:outline-none dark:focus:ring-primary-800 text-white" href="{{ route('businesses.index') }}">< Back</a>
            </div>
        </div>
            ...
            <div class="flex flex-col">
                <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    ...
                    <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10"> 
                        ...
                        <form action="{{ route('businesses.update',['id' =>$businesses->id]) }}" method="POST" autocomplete="off">
                            @csrf
                         

                            <div>
                                <label class="block text-md font-bold text-gray-700" for="title">Company:</label>
                                <input type="text" placeholder="Email"
                                    class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                                     name="businessname" value="{{ $businesses->businessname }}" autocomplete="off" required >
                            </div>
