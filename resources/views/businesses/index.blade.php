...
<!-- END INDEX SHOW CRUD--> 
    <div class="max-w-4xl mx-auto mt-8 my-5 pb-5 py-5">
      ...
      <div class="flex justify-end mt-10">
          <a href="{{ route('businesses.create') }}" class="bg-blue-700 hover:bg-blue-800 focus:ring-4
          focus:ring-blue-300 font-medium rounded-lg
           text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2
            dark:bg-blue-600 dark:hover:bg-blue-700 
            focus:outline-none dark:focus:ring-blue-800 text-white">+ Create New Company</a>
      </div>
