    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 mx-auto">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="/businesses" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">
            <a href="/businesses" class="text-blue-600 hover:text-blue-700">@yield('titulo')</a></a>
        </div>
      </li>
...
<!-- END INDEX SHOW CRUD--> 
    <div class="max-w-4xl mx-auto mt-8 my-5 pb-5 py-5">
      ...
      <div class="flex justify-end mt-10">
          <a href="{{ route('businesses.create') }}" class="bg-primary-700 hover:bg-primary-800 focus:ring-4
          focus:ring-primary-300 font-medium rounded-lg
           text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2
            dark:bg-primary-600 dark:hover:bg-primary-700 
            focus:outline-none dark:focus:ring-primary-800 text-white">+ Create New Company</a>
      </div>
                        ...
                        <table class="min-w-full text-center ">
                          ...
                          <tbody>
                            ...
                            <tr class="bg-white border-b">
                              ...
                              <td class="text-sm text-gray-900 font-bold px-6 py-4 whitespace-nowrap uppercase">
                              ...
                              <td class="text-sm text-gray-900 font-bold px-6 py-4 whitespace-nowrap">
                                <form action="{{ route('businesses.destroy',['id' =>$business->id]) }}" id="form-delete" method="POST">
                      @csrf
                   
                                  <a class="text-indigo-600 hover:text-indigo-900" 
                                  href="{{ route('businesses.show',['id' =>$business->id]) }}">
                                  ...
                                  <a href="{{ route('businesses.edit',['id' =>$business->id]) }}" class="text-indigo-600 hover:text-indigo-900 ">
                                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
