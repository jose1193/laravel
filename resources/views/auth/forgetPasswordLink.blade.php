          ...
          <form action="{{ route('reset.password.post') }}" method="POST" autocomplete="off">
            ...
            <input type="hidden" name="token" value="{{ $token }}">
              <div>
                  ...
                  <input type="email" name="email" id="email_address" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required>
                  @if ($errors->has('email'))
              ...
              <button type="submit" class="w-full text-white bg-primary-600
               ...
               dark:focus:ring-primary-800 mt-3">Change Password</button>
          </form>
      </div>
  </div>
</section>
