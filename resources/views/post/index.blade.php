    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 mx-auto">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="/post" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">
            <a href="/post" class="text-blue-600 hover:text-blue-700">@yield('titulo')</a></a>
        </div>
      </li>
...
<!-- END INDEX SHOW EMAILS CRUD--> 
    <div class="max-w-4xl mx-auto mt-8 my-5 pb-5 py-5">
      ...
      <div class="flex justify-end mt-10">
          <a href="{{ route('posts.create') }}" class="bg-blue-700 hover:bg-blue-800 focus:ring-4
          focus:ring-blue-300 font-medium rounded-lg
           text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2
            dark:bg-blue-600 dark:hover:bg-blue-700 
            focus:outline-none dark:focus:ring-blue-800 text-white">+ Create New Email</a>
      </div>
                        ...
                        <table class="min-w-full text-center ">
                          ...
                          <tbody>
                            ...
                            <tr class="bg-white border-b">
                              ...
                              <td class="text-sm text-gray-900 font-bold px-6 py-4 whitespace-nowrap">
                                <form action="{{ route('posts.destroy',$post->id) }}" id="form-delete" method="POST">
                      @csrf
