    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 mx-auto">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="/about" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white"><a href="/about" class="text-blue-600 hover:text-blue-700">@yield('titulo')</a></a>
        </div>
      </li>
